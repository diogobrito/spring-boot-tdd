...
public class PessoaRepositoryTest {
    ...
    public void nao_deve_encontrar_pessoa_cujo_ddd_e_telefone_nao_estejam_cadastrados() throws Exception{
        ...
        Optional<Pessoa> optional = sut.findByTelefoneDddAndTelefoneNumero("11", "23556689");
    ...
    @Test
    public void deve_fitrar_pessoas_por_parte_do_cpf() throws Exception {
    ...
    @Test
    public void deve_filtar_pessoas_por_filtro_composto() throws Exception {
        PessoaFiltro filtro = new PessoaFiltro();
